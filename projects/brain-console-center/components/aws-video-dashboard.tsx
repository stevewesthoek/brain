        ...
        <main className="aws-main-panel">
          ...
          {activeView === 'publish' ? (
            <article className="card publish-panel aws-publish-card">
              ...
              {requiresReviewGate && !reviewApproved ? <div className="compact-error">Review gate is enforced for generated media. Dry-run and private publish stay disabled until review is approved.</div> : null}
              {reviewApproved && requiresReviewGate ? <div className="success-panel">Review approved. Dry-run is now enabled.</div> : null}
              {dryRunRunning ? <div className="compact-error">Dry-run is running... Page refresh is safe; state persists in publish-check.json.</div> : null}
