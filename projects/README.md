...
- `brain-console/` — accepted Brain Console local operations dashboard, backed by Brain Core API; see `projects/brain-console/README.md` and `operations/runbooks/brain-console-operations.md`
