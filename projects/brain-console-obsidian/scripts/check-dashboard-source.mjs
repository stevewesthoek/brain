...
assert(main.includes('brain-console-dashboard-stable-2026-05-19-01'), 'main.ts missing current build marker');
...
assert(styles.includes('.brain-console__build-marker'), 'styles.css missing technical monospace build marker styling');
assert(styles.includes('minmax(280px, 1fr)'), 'styles.css missing dashboard grid minmax(280px, 1fr)');
