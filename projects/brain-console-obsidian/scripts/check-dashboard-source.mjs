...
assert(main.includes('brain-console-local-apps-orchestrator-2026-05-19-01'), 'main.ts missing current build marker');
...
assert(view.includes('Local Apps dashboard payload'), 'view.ts missing local apps dashboard content');
...
assert(styles.includes('minmax(200px, 1fr)') || styles.includes('minmax(180px, 1fr)'), 'styles.css missing compact dashboard grid minmax');
