...
During review phase: converts first scene PNG to JPEG, writes `thumbnail.json` metadata, syncs to S3. YouTube package automatically gets `thumbnailKey` populated.
