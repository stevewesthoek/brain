...
import { writeMaintenancePreviewArtifact, listMaintenancePreviewArtifacts, readMaintenancePreviewArtifact, } from '../preview-artifacts.js';
...
test('preview-artifacts: writes queue artifact to safe runtime root', () => {
    ...
    try {
        ...
        const runtimeRoot = path.join(tempDir, 'runtime/local/mind-steward/maintenance-previews');
