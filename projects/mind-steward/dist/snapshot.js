...
export function createMindPathSnapshotFromRoot(rootPath, relativePaths) {
...
function collectPathStatus(rootPath, relativePath) {
...
function isSmallMarkdownFile(relativePath, sizeBytes) {
    return relativePath.toLowerCase().endsWith('.md') && sizeBytes <= SMALL_MARKDOWN_SIZE_LIMIT;
}
function pathHasTrailingSlash(relativePath) {
