...
Prompt-derived metadata with TTS narration, model-generated scene images, and a locally assembled slideshow MP4. Brain Core keeps the working FFmpeg slideshow assembly path, but swaps deterministic scene images for the configured image provider.
