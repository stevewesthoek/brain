...
export async function getVideoOrchestratorControlPlane(
  ...
  return {
    ...
    artifacts: {
      ...
      videoKey: artifactsData?.videoKey ?? artifactsData?.finalVideoKey ?? artifactsData?.finalVideo ?? null,
      finalVideoKey: artifactsData?.finalVideoKey ?? artifactsData?.finalVideo ?? artifactsData?.videoKey ?? null,
      thumbnailKey: artifactsData?.thumbnailKey ?? artifactsData?.thumbnail ?? null,
