...
function generateDualRunEvidenceSection(): BrainCoreVideoProductionGateSection {
  const items: BrainCoreVideoProductionGateItem[] = [
    ...
    {
      id: 'dualrun-no-execution',
      label: 'No real dual-run execution implemented',
      category: 'dual-run-evidence',
      status: 'blocked',
      severity: 'critical',
      evidence: [
        'Video orchestrator is planning and validation layer only',
        'Cannot execute video rendering in parallel with STB',
        'Cannot compare actual STB vs video output',
      ],
      blockers: [
        'No video execution layer',
    ...
    {
      id: 'dualrun-comparison-blocked',
      label: 'Output comparison not available',
      category: 'dual-run-evidence',
      status: 'blocked',
      severity: 'critical',
      evidence: [
        'Real dual-run output comparison requires video execution',
        'Evidence-based parity cannot be validated without rendered artifacts',
      ],
      blockers: [
        'No video rendering',
        'No artifact comparison tooling',
        'No parity metrics available',
      ],
      safety: {
        readOnly: true,
        executesStb: false,
  ...
  return {
    ...
    blockerReason: 'Video orchestrator cannot execute rendering; remains validation layer only',
  };
}
