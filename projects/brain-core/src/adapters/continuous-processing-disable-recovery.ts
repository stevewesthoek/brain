...
export function getContinuousProcessingDisableRecoveryView(): BrainCoreContinuousProcessingDisableRecoveryView {
  ...
  return {
    ...
    disableProcedure: {
      ...
      dataIntegrity: 'Brain-owned queue state is preserved. Mind captures remain in canonical inbox/new/ unchanged. Queue state file is not deleted or modified by the kill switch.',
    },
    recoveryProcedure: {
      steps: [
        {
