...
const BRAIN_JARVIS_CONTEXT_SOURCE = 'brain.jarvis.context' as const;
const JARVIS_CONTEXT_READY_EVENT = 'jarvis.context.ready' as const;
...
export const SPAWN_ROLE_CONTEXT_READ_ONLY = 'agent-mode.role.context-read-only.v1' as const;
...
export const SPAWN_POLICY_CONTEXT_READ_ONLY = 'agent-mode.policy.context-read-only.v1' as const;
...
export const AGENT_MODE_ROLE_TEMPLATES: readonly AgentRoleTemplate[] = Object.freeze([
  ...
  },
  {
    ...
    version: 1,
    displayName: 'Context-scoped read-only worker',
    capabilities: [WORKCELL_READ_CAPABILITY],
    maxTtl: 15 * 60 * 1000,
    maxSteps: 100,
    maxBudget: 0.25,
...
export const AGENT_MODE_SPAWN_POLICIES: readonly AgentSpawnPolicy[] = Object.freeze([
  ...
  },
  {
    ...
    resourceScopeRules: { allowed: [], requireEventMatch: true },
    rootBudgetRules: { requireRemainingFacts: true, maxAggregateChildSteps: 1, maxAggregateChildBudget: 0.25 },
    deadlineRules: { requireDeadline: true, maxTtl: 10 * 60 * 1000 },
  },
  {
    schemaVersion: SPAWN_POLICY_SCHEMA_VERSION,
    policyId: SPAWN_POLICY_CONTEXT_READ_ONLY,
    version: 1,
    enabled: true,
    allowedSourceTypes: [BRAIN_JARVIS_CONTEXT_SOURCE],
    allowedEventTypes: [JARVIS_CONTEXT_READY_EVENT],
    allowedRoleTemplateIds: [SPAWN_ROLE_CONTEXT_READ_ONLY],
    maxSpawnDepth: 1,
    maxConcurrentChildren: 4,
    maxTotalChildCreations: 16,
    maxChildTtl: 15 * 60 * 1000,
