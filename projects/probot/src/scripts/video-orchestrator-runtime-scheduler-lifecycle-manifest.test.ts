...
test("VO-7FU-RUNTIME-SCHEDULER-LIFECYCLE-MANIFEST-REVIEW-1: renderer is safe and explicit", () => {
  ...
  assert.equal(text.includes("persistent-store approval, contract, adapter-plan, adapter-skeleton, dry-run fixture, validation, and review-summary packets are available"), true);
