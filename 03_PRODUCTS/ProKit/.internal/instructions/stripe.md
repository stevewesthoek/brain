# ProKit - Stripe Integration Guide

These guidelines are app-agnostic and apply to any SaaS product built on ProKit. This document defines how Stripe must be integrated, protected, and extended in a safe and predictable way for all future apps.
...
These rules ensure that Codex 5.1 interacts safely with the Stripe billing system inside ProKit. Codex MUST follow these rules for all future apps.
