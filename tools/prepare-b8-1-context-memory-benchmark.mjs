...
export function buildCanonicalPlan({
  ...
  if (repoRoot) {
    const componentFiles = {
      ...
      processSampler: 'tools/lib/b8-1-process-metrics.mjs',
      incrementalReindex: 'tools/lib/b8-1-cbm-incremental-reindex.mjs',
      exactSourceWorker: 'tools/lib/b8-1-exact-source-worker.mjs',
