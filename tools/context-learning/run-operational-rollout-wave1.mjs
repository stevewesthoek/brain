...
const promptFamilies = ['Research public evidence about climate analytics with citations.', 'Research the small-business software market with source-backed claims.', 'Research the technical tradeoffs of browser rendering with authority.', 'Research current 2026 browser compatibility facts with freshness.', 'Fact check the claim that responsive design improves mobile completion with primary sources.', 'Research contradictory evidence about remote-work productivity and preserve uncertainty.', 'Research the Sermon on the Mount passage with scholarly sources.', 'Research Hebrew and Greek lexical disagreement for the creation account passage.', 'Research scholarly disagreement about authorship of the Gospel of John.', 'Research Lisbon public-transit accessibility and local context.'];
