...
GRAPHIFY_FAST_MODEL="${GRAPHIFY_FAST_MODEL:-Youssofal/Qwen3.6-27B-MTPLX-Optimized-Quality}"
GRAPHIFY_DOCS_FAST_MODEL="${GRAPHIFY_DOCS_FAST_MODEL:-$GRAPHIFY_FAST_MODEL}"
GRAPHIFY_REFINED_MODEL="${GRAPHIFY_REFINED_MODEL:-Youssofal/Qwen3.6-27B-MTPLX-Optimized-Quality}"
GRAPHIFY_DEEP_MODEL="${GRAPHIFY_DEEP_MODEL:-$GRAPHIFY_REFINED_MODEL}"

OPENAI_BASE_URL="${OPENAI_BASE_URL:-http://127.0.0.1:8000/v1}"
OPENAI_API_KEY="${OPENAI_API_KEY:-sk-proj-mtplx-internal-000000}"
