...
const SUPPLEMENTAL_SOURCES = Object.freeze([
  ...
  { capabilityId: 'adapter.shared-visual-runtime', kind: 'adapter', role: 'adapter', label: 'Shared Brain Visual Runtime', sourceRef: 'tools/context-learning/shared-visual-capability.mjs', domains: ['design', 'web', 'visual', 'quality'], intents: ['render_visual_artifact', 'capture_screenshot', 'visual_inspection', 'functional_browser_qa'], triggers: ['shared visual runtime', 'render visual artifact', 'screenshot evidence'], summary: 'Local workspace-only browser execution provider for rendered artifact and bounded browser evidence.', riskClass: 'low', confirmationClass: 'policy', qualityGateRefs: ['gate.visual-qa', 'gate.qa'] },
