...
- Postgres runs in Docker and is reachable at `localhost:5433` by default (configurable via `POSTGRES_PORT`).
...
DATABASE_URL=postgresql://tenant_saaskit_user:<password>@<db-host>:5433/postgres?schema=tenant_saaskit
