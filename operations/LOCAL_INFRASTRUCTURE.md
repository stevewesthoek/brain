...
|-------------|------|----------|--------------|-------|
| **Oliveto Organizing** | 5453 | `olivetoorganizing` | `operations/database/standalone/olivetoorganizing/docker-compose.yml` | Reserved standalone OrbStack Postgres stack. |
