...
| **Olive To Organizing** | 3059 | Client website with TinaCloud CMS | `prochattools/clients/olive-to-organizing` | ProBot Local Apps registry | Local app port 3059; local OrbStack Postgres 5453. Production uses `https://olivetoorganizing.com`, not localhost. |

## Local Database Ports

| Application | Port | Database | Compose Path | Notes |
|-------------|------|----------|--------------|-------|
| **Olive To Organizing** | 5453 | `olivetoorganizing` | `operations/database/standalone/olivetoorganizing/docker-compose.yml` | Reserved standalone OrbStack Postgres stack. |
