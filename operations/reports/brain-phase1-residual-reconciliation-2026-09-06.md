...
| Item | Current state |
|---|---|
| `origin/main` | equal to clean local `main` at the latest verification |
| clean local `main` | equal to `origin/main` at the latest verification |
