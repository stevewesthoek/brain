...
| 6 | Bounded final validation | Recluster/validate the current graph by default. Extraction is disabled unless `GRAPHIFY_PHASE6_EXTRACT=1`; expensive `--mode deep` additionally requires `GRAPHIFY_PHASE6_DEEP_MODE=1` | Validated |
...
GRAPHIFY_FAST_MODEL="Youssofal/Qwen3.6-27B-MTPLX-Optimized-Speed" \
GRAPHIFY_DOCS_FAST_MODEL="Youssofal/Qwen3.6-27B-MTPLX-Optimized-Speed" \
GRAPHIFY_REFINED_MODEL="Youssofal/Qwen3.6-27B-MTPLX-Optimized-Speed" \
GRAPHIFY_DEEP_MODEL="Youssofal/Qwen3.6-27B-MTPLX-Optimized-Speed" \
