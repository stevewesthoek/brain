...
| 6 | Bounded deep refinement | Generic high-signal docs pass using the normal extractor by default; expensive `--mode deep` requires `GRAPHIFY_PHASE6_DEEP_MODE=1` | Active, bounded |
