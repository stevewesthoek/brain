...
| `PROBOT_BRAIN_ROOT` | `~/.config/probot/.env` | 2026-06-20 |
| `PROBOT_DATA_DIR` | `~/.config/probot/.env` | 2026-06-20 |
| `PROBOT_NOTES_DIR` | `~/.config/probot/.env` | 2026-06-20 |
| `PROBOT_ALLOWED_ROOTS` | `~/.config/probot/.env` | 2026-06-20 |
| `PROBOT_MAX_FILE_MB` | `~/.config/probot/.env` | 2026-06-20 |
| `PROBOT_DEBUG` | `~/.config/probot/.env` | 2026-06-20 |
...
| `PROBOT_DASHBOARD_PORT` | `~/.config/probot/.env` | 2026-06-20 |
| `PROBOT_DASHBOARD_URL` | `~/.config/probot/.env` | 2026-06-20 |
| `SLACK_BOT_TOKEN` | `~/.config/probot/.env` | 2026-06-20 |
| `SLACK_APP_TOKEN` | `~/.config/probot/.env` | 2026-06-20 |
| `SLACK_ALLOWED_USER_IDS` | `~/.config/probot/.env` | 2026-06-20 |
| `PROBOT_REPO_ALIASES` | `~/.config/probot/.env` | 2026-06-20 |
