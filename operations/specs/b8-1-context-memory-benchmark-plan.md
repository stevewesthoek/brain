...
**Status:** B8.1 incomplete — post-v7y scoring repair is validated and canonical v7z is awaiting exact owner approval; no materialization or execution is authorized
**Date:** 2026-08-10 (v7y disposition); 2026-08-09 (v7x and v7w dispositions); 2026-08-06 (v6 historical); 2026-08-04 (v5s historical)
**Dependency:** This plan does NOT authorize activation of any context-memory service.
**Next step:** Review the v7z contract 7.3.0 dry-run package. Materialization and execution remain forbidden until the owner supplies exact approval for run `b8-1-canonical-authorization-20260810-final-v7z` and digest `02971f6e644b004094ec6b60015ad3a5c379b63c25b14ea292ce425a5618dcbf` with the bound Node identity, subjects, Graphify exclusion, and partial-evidence state.
...
B8.1 is the first canonical task in Priority 8 (context-memory efficiency and freshness). It remains incomplete after the rejected v7y execution. No task in P8 is accepted as complete.
...
**v7y execution (2026-08-09 UTC):** The owner-approved canonical plan selected `cbm,exact-source`, excluded Graphify, and passed all preflight bindings before one materialization and one execution. Exact-source passed 10/10. CBM passed 8/10, with 80% file accuracy and 70% line accuracy; Brain/Workbench refresh latency was 1,150/530 ms and aggregate CBM peak RSS was 572.75 MB. The committed-manifest evidence validator returned valid, but the run fails the 90% file, 80% line, 500 ms refresh, and 512 MB RSS thresholds. The run is rejected, its authorization is consumed, and the immutable evidence is preserved under SHA-256 `bc6406e4f15d7c0e81d69168395a23acb9c5b062f89db10c23629ae38afc0f78`. Partial evidence cannot complete B8.1 or authorize B8.2.

**v7y post-run diagnosis and repair (2026-08-10):** Inspection proved `brain_f4` is absent because CBM v0.9.0 fast mode excludes the top-level `tools` directory, while full mode indexes the same file. Contract 7.3.0 / evidence schema 3.2.0 repairs inventory counting, line applicability, set outcome scoring, and required CBM caller/callee precision/recall/F1 evidence. Real isolated CBM validation and 191/191 focused tests pass. Evidence: `operations/reports/b8-1-v7y-post-run-diagnosis-2026-08-10.md` and `operations/reports/b8-1-post-v7y-repair-and-v7z-readiness-2026-08-10.md`.

**v7z dry-run (2026-08-10):** The non-materializing preflight for run `b8-1-canonical-authorization-20260810-final-v7z` passed with zero blockers under plan version 7.3.0 and digest `02971f6e644b004094ec6b60015ad3a5c379b63c25b14ea292ce425a5618dcbf`. It selects `cbm,exact-source`, excludes Graphify, and records partial evidence. No run directory exists; no materialization or execution is authorized without fresh exact owner approval.
