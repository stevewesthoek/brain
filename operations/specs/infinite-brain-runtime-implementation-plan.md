...
- **Status:** incomplete after rejected v7x run. The owner-approved v7x plan was materialized once and executed once: exact-source passed 10/10, CBM produced 3 passes, 1 failure, and 6 errors, and canonical evidence validation failed. The authorization is consumed, current execution authority is `none`, B8.2–B8.6 remain blocked, and P8 remains 0/6 accepted. Evidence: [v7x failed-run disposition](../reports/b8-1-failed-run-disposition-v7x-2026-08-09.md).
