...
- **Status:** incomplete after rejected v7y run; post-v7y repair validated and v7z awaiting exact owner approval. Real isolated CBM proved `brain_f4` is omitted by the provider's fast-mode top-level `tools` exclusion. Contract 7.3.0 / evidence schema 3.2.0 repairs count inventory, line applicability, set outcomes, and required CBM caller/callee precision/recall/F1. The v7z dry-run passed with zero blockers, but no run directory exists and current materialization/execution authority is none. B8.2–B8.6 remain blocked and P8 remains 0/6 accepted. Evidence: [v7y failed-run disposition](../reports/b8-1-failed-run-disposition-v7y-2026-08-10.md), [v7y post-run diagnosis](../reports/b8-1-v7y-post-run-diagnosis-2026-08-10.md), [post-v7y repair and v7z readiness](../reports/b8-1-post-v7y-repair-and-v7z-readiness-2026-08-10.md).
