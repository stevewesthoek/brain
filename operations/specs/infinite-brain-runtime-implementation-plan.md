...
- **Status:** incomplete after rejected v7x run. The v7x filesystem-order refresh-target defect is proven, repaired under contract 7.2.0/evidence 3.1.0, and validated 9/9 with the pinned real CBM. Canonical v7y dry-run passed with zero blockers but is not materialized or execution-authorized. B8.2–B8.6 remain blocked and P8 remains 0/6 accepted. Evidence: [v7x failed-run disposition](../reports/b8-1-failed-run-disposition-v7x-2026-08-09.md), [v7y repair readiness](../reports/b8-1-refresh-target-repair-and-v7y-readiness-2026-08-09.md).
