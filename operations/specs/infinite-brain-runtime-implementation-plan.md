...
- **Status:** incomplete after rejected v7y run. Canonical v7y was materialized once and executed once under the exact owner-approved plan. Exact-source passed 10/10 and CBM recorded 8/10, but CBM failed resource thresholds and required caller/callee F1 is absent. A read-only post-run audit also proved the count fixture, metric applicability, and set-outcome scoring are not admission-grade, so the schema-valid accuracy aggregates cannot support acceptance. The approval is consumed, current execution authority is none, B8.2–B8.6 remain blocked, and P8 remains 0/6 accepted. Evidence: [v7y failed-run disposition](../reports/b8-1-failed-run-disposition-v7y-2026-08-10.md), [v7y post-run diagnosis](../reports/b8-1-v7y-post-run-diagnosis-2026-08-10.md), [v7y repair readiness](../reports/b8-1-refresh-target-repair-and-v7y-readiness-2026-08-09.md).
