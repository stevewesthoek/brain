...
- **Status:** incomplete after rejected v7y run. Canonical v7y was materialized once and executed once under the exact owner-approved plan. Its evidence is schema-valid, exact-source passed 10/10, and CBM passed 8/10, but CBM failed the file-accuracy, line-accuracy, incremental-refresh, and peak-RSS thresholds. The approval is consumed, current execution authority is none, B8.2–B8.6 remain blocked, and P8 remains 0/6 accepted. Evidence: [v7y failed-run disposition](../reports/b8-1-failed-run-disposition-v7y-2026-08-10.md), [v7y repair readiness](../reports/b8-1-refresh-target-repair-and-v7y-readiness-2026-08-09.md).
