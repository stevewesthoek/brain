...
- **Status:** `B8.1 V2 READY — AWAITING OWNER APPROVAL`. Architecture-derived Contract V2 is implemented and validated by five independent disposable CBM v0.9.0 full-mode runs; all coverage, accuracy, structural, exact-source/fallback, isolation, lifecycle, cleanup, and headroom gates passed. Installed v0.9.0 is retained; disposable v0.9.1-rc.1 was rejected. The fresh dry-run-only package passed 15/15 checks, but no canonical run directory exists and current materialization/execution authority is none. B8.2–B8.6 remain blocked and P8 remains 0/6 accepted. Evidence: [v7y failed-run disposition](../reports/b8-1-failed-run-disposition-v7y-2026-08-10.md), [v7y post-run diagnosis](../reports/b8-1-v7y-post-run-diagnosis-2026-08-10.md), [post-v7y repair and v7z readiness](../reports/b8-1-post-v7y-repair-and-v7z-readiness-2026-08-10.md), [Contract V2 and authorization readiness](../reports/b8-1-v2-contract-and-authorization-readiness-2026-08-10.md).
