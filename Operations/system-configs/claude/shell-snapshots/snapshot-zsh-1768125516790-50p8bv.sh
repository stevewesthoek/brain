...
if ! command -v rg >/dev/null 2>&1; then
  alias rg=''\''/Users/Office/Library/Application Support/com.conductor.app/bin/claude'\'' --ripgrep'
fi
export PATH='/Users/Office/.antigravity/antigravity/bin:/opt/homebrew/bin:/opt/homebrew/sbin:/Users/Office/.nvm/versions/node/v24.12.0/bin:/usr/local/bin:/System/Cryptexes/App/usr/bin:/usr/bin:/bin:/usr/sbin:/sbin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin:/opt/pmk/env/global/bin:/Users/Office/Library/Application Support/com.conductor.app/./bin'
